...
function crunchify_social_sharing_buttons_settings(){
    ...
    register_setting("crunchify_social_sharing_config_section", "crunchify-social-sharing-linkedin");
    register_setting("crunchify_social_sharing_config_section", "crunchify-social-sharing-whatsapp");
...
function crunchify_social_sharing_checkbox(){  
   ?>
    <div class="postbox" style="width: 65%; padding: 30px;">
        ...
        <br><br><input type="checkbox" name="crunchify-social-sharing-whatsapp" value="1" <?php checked(1, get_option('crunchify-social-sharing-whatsapp'), true); ?> /> WhatsApp (only for Mobile devices)
        ...
        <br><br><input type="checkbox" name="crunchify-social-sharing-linkedin" value="1" <?php checked(1, get_option('crunchify-social-sharing-linkedin'), true); ?> /> LinkedIn
...
function add_crunchify_social_sharing_buttons($content) {
        ...
        if(get_option("crunchify-social-sharing-whatsapp") == 1){
			$content .= '<a class="crunchify-link crunchify-whatsapp" href="'. $whatsappURL .'" target="_blank" '. $rel_nofollow .'>WhatsApp</a>';
        }
        ...
        if(get_option("crunchify-social-sharing-linkedin") == 1){
			$content .= '<a class="crunchify-link crunchify-linkedin" href="'.$linkedInURL.'" target="_blank" '. $rel_nofollow .'>LinkedIn</a>';
        }
